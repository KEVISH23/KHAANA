...
<div class="page-content p-5" id="content">
  ...
  <!-- Demo content -->
  <h2 class="display-4 text-white mb-2">Feedbacks</h2>
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="adminfeedback.html">Recent FeedBacks</a></li>
      <li class="breadcrumb-item active">View All Feedbacks</li>
      
    </ol>
  </nav>
  <div class="container">
    <div class="row">
        <h3 class="display-4 text-white mb-2">View All FeedBacks(Curd System)</h3>
   </div>
