...
<div class="page-content p-5" id="content">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="adminvalldelivery.html">View All Delivery</a></li>
       ...
       <div class="col-lg-8 offset-2">
        <form>
          <div class="form-group flabel">
            ...
            <input type="text" class="form-control" id="inputdelivery" name="vdel"  placeholder="Enter Delivery Man ID" required>
          </div>
          <div class="container">
            <div class="row">
