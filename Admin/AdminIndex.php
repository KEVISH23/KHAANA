...
<html>
<head>
<<<<<<< HEAD:Admin/AdminIndex.php
    <title>Dashboard</title>
=======
    <title>admin </title>
>>>>>>> e00d5d3c0b254fd3258de892278b034c0c980f71:Admin/AdminIndex.html
...
<div class="page-content p-5" id="content">
  ...
  <div class="container mt-5">
    <div class="row">
        <h3 class="display-4 text-white mb-2">New Cook Listing</h3>
   </div>
  <table class="table bg-info text-white table-hover mt-4">
      <thead>
          <tr>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col align-self-end">
        <a href="adminfeedback.html" class="btn btn-warning">View all Feedbacks</a>
      </div>
   </div>
