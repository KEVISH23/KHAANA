...
<div class="page-content p-5" id="content">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="admindelivery.html">Recent Delivery</a></li>
      <li class="breadcrumb-item active">View All Delivery</a></li>
      <li class="breadcrumb-item"><a href="adminparticulardel.html">View Particular Delivery</a></li>
      <li class="breadcrumb-item"><a href="admindeliverypayment.html">Payment</a></li>
      
    </ol>
  </nav>
  <div class="container">
    <div class="row">
        <h3 class="display-4 text-white mb-2">View All Delivery (Curd System)</h3>
   </div>
