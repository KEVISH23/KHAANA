...
<html>
<head>
    <title>Particular Customer</title>
...
<div class="page-content p-5" id="content">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="adminalluser.php">View All Customer</a></li>
      <li class="breadcrumb-item active">View Particular Customer</li>
      <li class="breadcrumb-item"><a href="admiccookorder.php">Customer orders</a></li>
      
    </ol>
  </nav>
<!--FORM FOR DELIVERY BOY PAYMENT-->
<h2 class="display-4 text-white mb-2">User Id</h2>
