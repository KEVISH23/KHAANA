       ...
       <div class="col-lg-8 offset-2">
        <form method="post">
          <div class="form-group flabel">
            ...
            <input type="text" class="form-control" name="delid" id="inputdelivery"  placeholder="Enter Delivery ID" required>
          </div>
          <div class="container">
            <div class="row">
...
if (isset($_POST['delid'])) {
  ...
  global $con;
  $delid = $_POST['delid'];
  $q = "select * from delivery where delivery_id = $delid";
  ...
  if ($r) {
    ...
    if ($rc > 0) {
      ...
      echo "<div class='alert alert-danger alert-dismissible fade show fixed-top' role='alert'>
        <strong>Oops!</strong>No Such Delivery Man Exist.
